...
set DOST_PATCHES_CP=%DITA_HOME%\target\classes;%DITA_HOME%\plugins\com.oxygenxml.dost.patches\lib\*;%DITA_HOME%\lib\*;%DITA_HOME%\lib\saxon\*;%DITA_HOME%\plugins\com.oxygenxml.dost.patches\lib\oxygen-dost-patches.jar;
