<?xml version="1.0" encoding="UTF-8"?><!-- This stylesheet assembles all the basic dita to 
     ...
     transformation and the user extension point.--><xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0" exclude-result-prefixes="xs">
  ...
  <xsl:import href="plugin:com.oxygenxml.pdf.review:review/review-elements-to-html.xsl"/>  
