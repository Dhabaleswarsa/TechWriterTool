...
--><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:import xmlns:dita="http://dita-ot.sourceforge.net" href="plugin:com.oxygenxml.dita-ot.plugin.mathml:pdfMathML.xsl"/><xsl:import href="plugin:com.oxygenxml.editlink:xslfo.xsl"/><xsl:import href="plugin:com.oxygenxml.highlight:pdfHighlight.xsl"/><xsl:import href="plugin:com.oxygenxml.image.float:customFO.xsl"/><xsl:import href="plugin:com.oxygenxml.media:pdfMedia.xsl"/><xsl:import href="plugin:com.oxygenxml.pdf.custom:custom.xsl"/><xsl:import href="plugin:com.oxygenxml.pdf.review:review/review-pis-to-elements-pdf-classic.xsl"/><xsl:import href="plugin:org.lwdita:xsl/linebreak2fo.xsl"/><xsl:import href="plugin:org.dita-community.common.xslt:xsl/commonXsltExtensionSupport.xsl"/><xsl:import href="plugin:org.dita-community.dita13.pdf:xsl/dita13Vocab2Pdf.xsl"/>
